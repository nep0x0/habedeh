...
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/nrv-ous/Orion/main/Library.lua"))()

local Window = Library:CreateWindow("Bebek Hub")
local OtherTab = Window:CreateTab("Other")
local OtherSection = OtherTab:CreateSection("Other")
local ToggleState = false

local CommandBotToggle = OtherSection:CreateToggle("Command Bot", function(state)
    ToggleState = state
    if state then
        print("Toggle On")
    else
