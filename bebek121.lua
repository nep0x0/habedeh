...
local Window = Library:MakeWindow({Name = "Bebek Hub v1.2.1 Beta 9 dev 3.5", HidePremium = false, SaveConfig = true, ConfigFolder = "BebekHub"})
...
OtherSection:AddButton({
    ...
    Callback = function()
        ...
        if LocalPlayer then
            local username = LocalPlayer.Name -- Mendapatkan nama pemain lokal
            local vehicleName = username .. "sCar" -- Menambahkan "sCar" ke nama pemain
